...
const addTwo = (arr) => {
  // Solution code here...
  let newArray = [];
  arr.forEach ((value, index) => {newArray.push(value + 2);
  });
  return newArray;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  return arr.filter ((value) => {return value.includes('and');});
};
...
const oddValues = (arr) => {
  // Solution code here...
  return arr.filter ((value) => {return value % 2;});
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  return arr.filter ((value) => { return !forbiddenValues.includes(value);});
};
